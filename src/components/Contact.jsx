    ...
    <div className='bg-[#151414] text-[#FEFEFF]  '>
      <div className='   bg-[#151414]  text-[#FEFEFF]'>
        <div className='flex justify-center'>
          ...
          <h1 className='lg:text-7xl text-5xl md:mb-0 mb-6 lg:leading-normal font-semibold py-20   flex justify-center
        ...
        <div className='lg:flex  lg:justify-around'>
          <div className=''>
              <h1 className='lg:text-4xl text-3xl md:mb-4 mb-4 lg:leading-normal flex justify-center lg:pl-8 pl-12 '>
                If you have any queries or wanna join us,
